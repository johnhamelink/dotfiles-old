...
-- Register widget
vicious.register(mytextclock, vicious.widgets.date, "<span color=\"#737373\">%b %d, %R</span>", 60)

-- Initialize widget
mympdwidget = wibox.widget.textbox()
-- Register widget
vicious.register(mympdwidget, vicious.widgets.mpd,
    function (mympdwidget, args)
        if args["{state}"] == "Stop" then
            return ""
        else
            return "<span color=\"#1B9BE0\">MPD:</span> <span color=\"#737373\">" .. args["{Artist}"]..' - '.. args["{Title}"] .. "</span>"
        end
end, 20)
...
-- Register widget
vicious.register(mycpuwidget, vicious.widgets.cpu, "<span color=\"#1B9BE0\">CPU:</span> <span color=\"#737373\">$1%</span>")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn("mpc volume +20") end),
